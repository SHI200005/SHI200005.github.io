...
连续函数：物理学家喜欢研究的好函数，如果你像我一样胸无大志，就不用太管不连续函数（$$\delta$$ 函数除外，详见[复变函数](https://shi200005.github.io/2022/03/28/Complex-Functions/)）。
...
啊，虽然上面写的这么灵魂，但是对于吃透[数学物理方程](https://shi200005.github.io/2022/03/28/Partial-Differential-Equations/)课纲细节还不太够，比如说我们还要知道 $$\frac{d}{dt}\displaystyle\int_{\alpha(t)}^{\beta(t)}g(t;\tau)d\tau=\displaystyle\int_{\alpha(t)}^{\beta(t)}\frac{\partial g(t;\tau)}{\partial t}d\tau + g[t;\beta(t)]\frac{d\beta(t)}{dt} - g[t;\alpha(t)]\frac{d\alpha(t)}{dt}$$. 对于这个式子，知乎专栏“[如何对积分求导——夏草的璇涡冰激凌](https://zhuanlan.zhihu.com/p/547766124)”已经写得很详细了。用到的行列式微分引理详见[线性代数](https://shi200005.github.io/2021/09/30/Linear-Algebra/)。其中对于高维推广情形的理解，本人特意在完全不会**微分几何**的情况下只靠阅读这篇文章，读不太懂，于是打算自学微分几何玩。
...
驻点（saddle point，在[统计物理](https://shi200005.github.io/2022/09/10/Statistical-Mechanics/)中 saddle point approximation 很重要） -> 极值点。

考察极值点 -> Hessian Matrix 的正定/负定/...性质 -> [线性代数](https://shi200005.github.io/2021/09/30/Linear-Algebra/)

#### 重要应用

**齐次函数的欧拉定理**：若函数 $$f(x_1,x_2,...,x_n)$$ 是变量 $$x_1,x_2,...,x_n$$ 的 $$m$$ 次齐次多项式 -> $$f(\lambda x_1,\lambda x_2,...,\lambda x_n)=\lambda^mf(x_1,x_2,...,x_n)$$ -> $$\displaystyle\sum_{i=1}^n\frac{\partial f}{\partial x_i}x_i=mf$$.  应用：广义能量-[理论力学](https://shi200005.github.io/2022/01/25/Advanced-Classical-Mechanics/#%E6%8B%89%E6%A0%BC%E6%9C%97%E6%97%A5%E5%8A%9B%E5%AD%A6)。

**勒让德变换**：[热力学 - 麦克斯韦关系](https://shi200005.github.io/2021/10/11/Thermodynamics/#%E5%9D%87%E5%8C%80%E7%B3%BB%E7%9A%84%E5%B9%B3%E8%A1%A1%E6%80%A7%E8%B4%A8)、[理论力学 - 哈密顿正则方程](https://shi200005.github.io/2022/01/25/Advanced-Classical-Mechanics/#%E5%93%88%E5%AF%86%E9%A1%BF%E5%8A%9B%E5%AD%A6)。
...
**欧拉型常微分方程**上面没写，合理怀疑学的时候没当回事，但是[数学物理方程](https://shi200005.github.io/2022/03/28/Partial-Differential-Equations/)的球坐标系下拉普拉斯方程约化过的距离坐标所满足的方程就是欧拉型常微分方程。形式和解法详见[微分方程第九节* 欧拉方程 - Seintf的文章 - 知乎](https://zhuanlan.zhihu.com/p/349911260)。