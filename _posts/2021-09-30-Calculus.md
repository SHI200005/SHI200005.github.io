...
[Nabla 算符 ∇ 的运算律以及常用公式 - 東雲正樹的文章 - 知乎](https://zhuanlan.zhihu.com/p/52834609)：这个链接的封面图就是高斯定理微分形式有关的一个很常用的数学公式 $$\nabla^2\displaystyle\frac{1}{r}=-4\pi\delta(\vec r)$$，这是数学的关系，但是可以结合[电磁学 - 库仑定律](https://shi200005.github.io/2022/03/29/Electromagnetism/#%E5%BA%93%E4%BB%91%E5%AE%9A%E5%BE%8B)记忆——空间原点孤立点电荷形成的电势场。
