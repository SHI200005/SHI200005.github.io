...
链接：[概率论](https://shi200005.github.io/2021/10/02/Probability/)中有：[证明：协方差矩阵是半正定矩阵](https://blog.csdn.net/qcyfred/article/details/71598815)。（见下面“实对称矩阵”）
...
实对称矩阵典型例子：惯量张量（[力学](https://shi200005.github.io/2021/10/07/Classcal-Mechanics/)）、协方差矩阵（[概率论](https://shi200005.github.io/2021/10/02/Probability/)）。

链接：[概率论](https://shi200005.github.io/2021/10/02/Probability/)中有：[证明：协方差矩阵是半正定矩阵](https://blog.csdn.net/qcyfred/article/details/71598815)。直观地想象，将协方差矩阵合同对角化（施加刚性变换），得到线性变换后的各个变量的方差。这些变量的方差是非负的（半正定矩阵所有特征值都是非负的）。
