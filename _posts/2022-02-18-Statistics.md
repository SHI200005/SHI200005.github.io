...
版本 0.2 结尾：抱歉，数理统计部分还没怎么在实践中用过，因此先简要地写一下，以后用到再补充w。版本 1.0 开头：这部分内容在《机器学习》的背景理论中用到了，所以我回过头来写一写。
...
3. 来自正态分布总体的常用抽样分布
     ...
     - 卡方分布 $$\chi^2(n)$$：若$$X$$~$$N(0,1)$$，则$$\sum_{i=1}^{n}{X_i^2}$$~$$\chi^2(n)$$. 有表可查。也叫 **Gamma 分布**，在[概率论](https://shi200005.github.io/2022/02/17/Probability/#%E8%BF%9E%E7%BB%AD%E5%9E%8B%E9%9A%8F%E6%9C%BA%E5%8F%98%E9%87%8F)这里后面这张图里出现过，泊松过程第 $$n$$ 次事件出现的时间服从 Gamma 分布。
