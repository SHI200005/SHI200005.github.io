...
### 解析函数
在某点及其邻域上可导的函数解析。解析函数 -> [复变函数-平面标量场](https://shi200005.github.io/download_file/Complex_Functions_Field.pdf)、调和函数（拉普拉斯方程 $$\nabla^2u=0,\nabla^2v=0$$）（C-R条件再求导得到）、虚实可互求（电场线与等势线互求，电场线和等势线必须是调和函数）。在以后的课程里，感觉此部分似乎用处不大。
...
例题也放[复变函数-平面标量场](https://shi200005.github.io/download_file/Complex_Functions_Field.pdf)里了。得到[数学物理方程-m 阶贝塞尔函数](https://shi200005.github.io/download_file/Mat_Phy_Bessel.pdf)的洛朗展开详见详见[数学物理方程](https://shi200005.github.io/2022/03/28/Partial-Differential-Equations/)。
...
关于傅里叶变换和拉普拉斯变换在求解微分方程中的应用，参见[积分变换法 - 数学物理方程](https://shi200005.github.io/2022/03/28/Partial-Differential-Equations/#积分变换法)。
...
为什么要进行傅里叶变换？我们都有很直观的印象：发出一个元音，做频谱图，可以通过频谱特征分辨是哪个元（**语音识别**的原理之一）。不仅如此，在本科阶段，**量子力学**中的坐标表象和动量表象，**固体物理**中的倒格矢都是傅里叶变换；在研究生阶段，详见下文。
...
求解偏微分方程，详见[数学物理方程](https://shi200005.github.io/2022/03/28/Partial-Differential-Equations/)。
