...
对概率分布做**傅里叶变换**（参见[复变函数](https://shi200005.github.io/2022/02/15/Complex-Functions/#%E5%82%85%E9%87%8C%E5%8F%B6%E5%8F%98%E6%8D%A2)）得到 *the characteristic function* $$\tilde p(k)=\langle e^{-ikx}\rangle=\int dxp(x)e^{-ikx}$$，then moments of the PDF around any point $$x_0$$ can be generated by expanding $$e^{ikx_0}\tilde p(k)=\displaystyle\sum_{n=0}^\infty\frac{(-ik)^n}{n!}\langle(x-x_0)^n\rangle$$。
